...
/*TAPAS FRÍAS*/
INSERT INTO platos (nombre_plato, nombre_plato_cat, id_tipo, alergenos, imagen_plato, precio) VALUES
('Boquerones en vinagre', 'Boquerons en vinagre', 7, '[11]', NULL, 4.50),
('Anchoas del Cantábrico (6 filetes)', 'Anxoves del Cantàbric (6 filets)', 7, '[11]', NULL, 6.00),
('Gambas saladas', 'Gamba salada', 7, '[4]', NULL, 6.00),
('Salpicón de marisco', 'Salpicó de marisc', 7, '[9]', NULL, 6.00),
...
('Chipirones a la andaluza', 'Xipirons a la andalusa', 8, '[2,3,4,6,7,8,10,11,12,13,14]', NULL, 7.50),
('Chocos', 'Xocos', 8, NULL, NULL, 7.50),
('Calamares a la romana', 'Calamars a la romana', 8, '[6,7,9]', NULL, 6.50),
('Patitas de calamar', 'Potetes de calamar', 8, '[6,7,9]', NULL, 7.50),
('Gambas rebozadas (tempura)', 'Gambes arrebossades (tempura)', 8, '[4,6,7]', NULL, 7.50),
('Pulpitos a la plancha', 'Popets a la planxa', 8, '[9]', NULL, 8.50),
('Chipirones a la plancha', 'Xipirons a la planxa', 8, '[6,7,8,10,11,12,13]', NULL, 8.50),
('Sepia a la plancha cortada', 'Sípia a la planxa tallada', 8, '[9]', NULL, 10.00),
('Pulpo a la gallega', 'Pop a la gallega', 8, '[9]', NULL, 15.00),
('Gambas a la plancha (8 unidades)', 'Gambes a la planxa (8 unitats)', 8, '[4]', NULL, 12.00),
('Gambas al ajillo', 'Gambes al oli', 8, '[4]', NULL, 12.00),
('Mejillones al vapor', 'Musclos al vapor', 8, '[9]', NULL, 6.50),
('Mejillones a la marinera', 'Musclos a la marinera', 8, '[9]', NULL, 7.50);

/*BOCADILLOS ESPECIALES*/
INSERT INTO platos (nombre_plato, nombre_plato_cat, id_tipo, alergenos, imagen_plato, precio) VALUES
('Mediterráneo (atún, lechuga, tomate, mayonesa, olivas)', 'Mediterrani (tonyina, enciam, tomàquet, maionesa, olives)', 9, '[6,7,8,9,11]', NULL, 5.00),
